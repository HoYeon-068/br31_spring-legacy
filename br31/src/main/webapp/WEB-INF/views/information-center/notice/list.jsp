...
<div class="site-container">
    ...
    <section id="content" class="notice-list board-list">
        ...
        <form action="${pageContext.request.contextPath}/information-center/notice/list.do"
              method="get"
              class="board-search">
                            ...
                            <c:choose>
                                <c:when test="${not empty list}">
                                    <c:forEach var="dto" items="${list}">
                                        <c:url var="viewUrl" value="/information-center/notice/view.do">
                ...
                <ul class="pagination">
                    ...
                    <li class="pagination__item pagination__item--icon pagination__item--prev
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:url var="prevBlockUrl" value="/information-center/notice/list.do">
                    ...
                    <li class="pagination__item pagination__item--icon pagination__item--next
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:url var="nextBlockUrl" value="/information-center/notice/list.do">
