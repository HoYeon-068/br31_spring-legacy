        ...
        <div>
            <div class="menu-list">
				...
				<c:forEach items="${list}" var="vo">
					 <li class="menu-list__item  menu-list__item--drink" style="--menu-list-color: ${vo.bgColor}">
                            <a href="${pageContext.request.contextPath}/menu/view.do?seq=${vo.productsId}" class="menu-list__link">
                                <img src="${pageContext.request.contextPath}${vo.imgPath}" alt="버터팝콘쉐이크" class="menu-list__image">
                                <span class="menu-list__hash" style="color:${vo.spanColor}">
                            ${vo.tags}                              </span>
                            </a>
                            <strong class="menu-list__title">${vo.productName}</strong>
                            <strong class="menu-list__desc">${vo.subTitle}</strong>
                        </li>
				</c:forEach>
